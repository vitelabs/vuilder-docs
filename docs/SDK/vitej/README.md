...
ViteJ is a collection of Java libraries that allows you to interact with a local or remote Vite node using HTTP, IPC or WebSocket.

## Source Code

Source code: [ViteJ](https://github.com/vitelabs/vitej) 
